  ...
  head: () => ({
    meta: [
      ...
      { title: "Wintana Hotel | Modern Urban Retreat in Addis Ababa" },
      {
        name: "description",
        content:
          "Wintana Hotel offers a warm, contemporary stay in Addis Ababa with a rooftop pool, sky lounge, city-view terrace, and Ethiopian hospitality.",
      },
      { name: "author", content: "Wintana Hotel" },
      { property: "og:title", content: "Wintana Hotel | Modern Urban Retreat in Addis Ababa" },
      {
        property: "og:description",
        content:
          "Experience warm Ethiopian hospitality, a rooftop pool, and panoramic city views at Wintana Hotel.",
      },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:site", content: "@wintanahotel" },
    ],
    links: [
      {
        rel: "stylesheet",
